/* ════════════════════════════════════════════════════════════════════
   ...
   parallax are desktop/no-reduced-motion only. Mirrors heavy-
   structural-hero.js / concrete-reinforcement-hero.js / steel-strip-
   hero.js.
   ════════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  const particleHost = hero.querySelector('#stpParticles');
